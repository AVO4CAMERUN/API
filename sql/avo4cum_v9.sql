...
--
-- Host: 127.0.0.1
-- Creato il: Feb 03, 2022 alle 12:19
...
INSERT INTO `invitations` (`id_class`, `email`) VALUES
(29, 's5779870b@studenti.itisavogadro.it'),
(30, 's5779870b@studenti.itisavogadro.it'),
(31, 's5779870b@studenti.itisavogadro.it'),
(32, 's5779870b@studenti.itisavogadro.it');
...
ALTER TABLE `invitations`
  ADD PRIMARY KEY (`id_class`,`email`),
  ADD KEY `email` (`email`);
